...
pub fn add2(comptime typ: type , v1: *const typ , v2: *const typ ) typ
{
    return typ {.x = v1.x + v2.x, .y = v1.y + v2.y };
}

pub fn add3(comptime typ: type , v1: *typ , v2: *typ ) typ
{
    return type {.x = v1.x + v2.x, .y = v1.y + v2.y, .z = v1.z + v2.z };
}

pub fn add4(comptime typ: type , v1: *typ , v2: *typ ) typ
{
    return typ {.x = v1.x + v2.x, .y = v1.y + v2.y, .z = v1.z + v2.z, .w = v1.w + v2.w };
}


pub fn mul2(comptime typ: type , v1: *typ , v2: *typ ) typ
{
    return typ {.x = v1.x * v2.x, .y = v1.y * v2.y };
}

pub fn mul3(comptime typ: type , v1: *typ , v2: *typ ) typ
{
    return typ {.x = v1.x * v2.x, .y = v1.y * v2.y, .z = v1.z * v2.z };
}

pub fn mul4(comptime typ: type , v1: *typ , v2: *typ ) typ
{
    return typ {.x = v1.x * v2.x, .y = v1.y * v2.y, .z = v1.z * v2.z, .w = v1.w * v2.w };
}
